...
def parse_date(date_str: str) -> datetime | None:
    ...
    formats = [
        ...
        "%d-%m-%Y",    # 16-07-2025
        "%m/%d/%Y",    # 07/16/2025
        "%Y-%#m-%#d",  # 2025-7-16 (حذف الصفر)
        "%#d-%#m-%Y",  # 16-7-2025 (حذف الصفر)
        "%#m/%#d/%Y",  # 7/16/2025 (حذف الصفر)
    ]
    for fmt in formats:
        try:
        ...
        if date_time_match:
            ...
            if not parsed_time:
                response_text = (
                    ...
                    "- 14:30\n- 02:30 PM\n- 2:30\n\n"
                    "📅 التاريخ (أمثلة: 2025-07-16، 16-07-2025، 07/16/2025، 2025-7-16، 16-7-2025، 7/16/2025):\n\n"
                    "↩️ للرجوع للقائمة 🏠 الرئيسية (0)\n🔙 للرجوع إلى القائمة السابقة اضغط 00"
                )
                return {"text": response_text, "keyboard": "0||00"}
